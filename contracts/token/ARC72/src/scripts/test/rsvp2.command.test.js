...
describe("VNS:rsvp2 Test Suite", function () {
  this.timeout(60_000);
  ...
  it("can reserve test.voi outbid by owner 2", async function () {
    const deployerNodeBefore = bytesToBase64(
      await accountNode({
        apid: fixtureData.apps.vnsRsvp,
        account: addresses.deployer,
    ...
    const reserveR = await reserve({
      ...
      name: "test.voi",
      length: 4,
      extraPayment: BigInt(10000 + 200000 + 69000 + 1000000),
  ...
  it("can reserve test.voi outbid by deployer 3", async function () {
    const deployerNodeBefore = bytesToBase64(
      await accountNode({
        apid: fixtureData.apps.vnsRsvp,
        account: addresses.deployer,
    ...
    const reserveR = await reserve({
      ...
      name: "test.voi",
      length: 4,
      extraPayment: BigInt(10000 + 200000 + 69000 + 1000000 + 1),
      sender: addresses.deployer,
      sk: sks.deployer,
    });
    const deployerNodeAfter = bytesToBase64(
  ...
  it("can not reserve test.voi outbid by owner at same price 4", async function () {
    const deployerNodeBefore = bytesToBase64(
      await accountNode({
        apid: fixtureData.apps.vnsRsvp,
        account: addresses.deployer,
  ...
  it("can reserve test.voi outbid by owner at higher price 5", async function () {
    const deployerNodeBefore = bytesToBase64(
      await accountNode({
        apid: fixtureData.apps.vnsRsvp,
        account: addresses.deployer,
    ...
    const reserveR = await reserve({
      ...
      name: "test.voi",
      length: 4,
      extraPayment: BigInt(10000 + 200000 + 69000 + 1000000 + 2),
      sender: addresses.owner,
      sk: sks.owner,
    });
    const deployerNodeAfter = bytesToBase64(
